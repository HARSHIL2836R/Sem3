...
def main():
    ...
    for test_case_num in range(1, num_test_cases + 1):
        ...
        num_elements = max_nodes #random.randint(2, max_nodes)  # Adjust range as needed
        ...
        k_small = [random.randint(1, max(1,math.floor(math.log2(num_elements))) )]
        k_large = [random.randint(1, max(1,math.floor(math.log2(num_elements))) )]
        # k_small = [random.randint(1, num_elements)]
        # k_large = [random.randint(1, num_elements)]
