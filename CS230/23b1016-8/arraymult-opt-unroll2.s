...
loop:
    ...
    l.d f5, A(r4) ; a[i]
    l.d f6, B(r4) ; b[i]
    mul.d f7, f5, f6 ; c[i], temporary, 1 RAW Stall at M0 
    s.d f7, C(r4) ; 1 RAW at ID and 5 RAW at EX and 1 Str at EX (mul.d in MEM stage)
...
; Total cycles reduced from 221 to 193